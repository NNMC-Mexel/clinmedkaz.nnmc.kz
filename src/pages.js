...
const dictionary = {
  ru: {
    ...
    paymentForm: {
      ...
      nonResidentCharge: "К оплате для нерезидента Казахстана",
      exchangeRate: "Курс",
  ...
  kk: {
    ...
    paymentForm: {
      ...
      nonResidentCharge: "Қазақстан резиденті емес үшін төлем",
      exchangeRate: "Курс",
  ...
  en: {
    ...
    paymentForm: {
      ...
      nonResidentCharge: "Payment for non-resident of Kazakhstan",
