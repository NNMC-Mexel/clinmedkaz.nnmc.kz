...
export function paymentFormPage(invitation, options = {}) {
  ...
  const pricingJson = JSON.stringify({
    ...
    residentSubmit: t.residentSubmit,
    nonResidentSubmit: t.nonResidentSubmit,
