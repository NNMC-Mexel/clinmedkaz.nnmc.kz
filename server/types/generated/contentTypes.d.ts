...
export interface ApiInvitationInvitation extends Struct.CollectionTypeSchema {
  collectionName: 'payment_invitations';
  info: {
    description: 'Article publication payment invitation';
    displayName: 'Payment invitation';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    residentAmount: Schema.Attribute.Decimal;
    residentCurrency: Schema.Attribute.String;
    status: Schema.Attribute.Enumeration<
      ['created', 'payment_started', 'paid', 'failed', 'cancelled']
    > &
      Schema.Attribute.Required &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usdToKztRate: Schema.Attribute.Decimal;
  };
}
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Halyk ePay article publication payment';
  ...
  attributes: {
    accountingStatus: Schema.Attribute.Enumeration<
      ['new', 'reconciled', 'exported', 'disputed']
    > &
      Schema.Attribute.Required &
    ...
    halykReference: Schema.Attribute.String;
    invitationId: Schema.Attribute.String;
    ...
    paymentReceivedAt: Schema.Attribute.DateTime;
    paymentUpdatedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    phone: Schema.Attribute.String;
    postbacks: Schema.Attribute.JSON;
    publicationFeeUsd: Schema.Attribute.Decimal;
    ...
    residency: Schema.Attribute.Enumeration<['resident_kz', 'non_resident']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'resident_kz'>;
    secretHash: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Private;
    status: Schema.Attribute.Enumeration<
      [
...
export interface ApiPaymentCallbackPaymentCallback
  ...
  attributes: {
    amountChecked: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    amountOk: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    code: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    matched: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    matchedOrderId: Schema.Attribute.String;
    payload: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    receivedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    reference: Schema.Attribute.String;
    secretMatches: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
